...
import torch
from PINet.util_hourglass import *
...
import PINet.hard_sampling as hard_sampling
import os
...
class Agent(nn.Module):
    ...
    def load_weights(self, root_path):
        self.lane_detection_network.load_state_dict(
            torch.load(os.path.join(root_path, self.p.model_path), map_location='cuda:0'),False
        )
